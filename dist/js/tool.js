...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__index_ResourceTable__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__index_ResourceTable___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__index_ResourceTable__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        ResourceTable: __WEBPACK_IMPORTED_MODULE_2__index_ResourceTable___default.a
    },
...
Component.options.__file = "resources/js/components/index/ResourceTable.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2cae5248", Component.options)
  } else {
    hotAPI.reload("data-v-2cae5248", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ResourceTableRow__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ResourceTableRow___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__ResourceTableRow__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        ResourceTableRow: __WEBPACK_IMPORTED_MODULE_1__ResourceTableRow___default.a
    },
    props: {
        authorizedToRelate: {
            type: Boolean,
...
Component.options.__file = "resources/js/components/index/ResourceTableRow.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1326ecbc", Component.options)
  } else {
    hotAPI.reload("data-v-1326ecbc", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1326ecbc", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2cae5248", module.exports)
  }
}
            ...
            [
              _c(
                "router-link",
                {
                  ...
                  attrs: { to: { name: "nova-simple-cms-create" } }
                },
                [
                  _vm._v(
                    "\n                    " +
...
/* harmony default export */ __webpack_exports__["default"] = ({
            ...
            return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.next = 2;
                            return Nova.request('/nova-vendor/nova-simple-cms/blueprints');

                        case 2:
                            _ref2 = _context.sent;
                            blueprints = _ref2.data;
    ...
    methods: {
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 2:
                                ...
                                _context2.next = 6;
                                return Nova.request().get('/nova-vendor/nova-simple-cms/' + this.resourceName + '/creation-fields', {
                                    params: {
                                        editing: false,
                                        editMode: 'create',
                                        viaResource: this.viaResource,
        ...
        createRequest: function createRequest() {
            return Nova.request().post('/nova-vendor/nova-simple-cms/' + this.resourceName, this.createResourceFormData());
        ...
        createResourceFormData: function createResourceFormData() {
            ...
            return _.tap(new FormData(), function (formData) {
                _.each(_this.fields, function (field) {
                    if (field.attribute != 'id') field.fill(formData);
                });
                ...
                formData.append('blueprint', _this.blueprint);
            });
        }
    },
          ...
          [
            _c("div", { staticClass: "flex border-b border-40" }, [
              ...
              _c("div", { staticClass: "py-6 px-8 w-1/2" }, [
                    ...
                    on: {
                      change: [
                        function($event) {
                          ...
                          _vm.blueprint = $event.target.multiple
                            ? $$selectedVal
                            : $$selectedVal[0]
                        },
                        function($event) {
                          return _vm.getFields()
                        }
                      ]
                    }
                  },
                  _vm._l(_vm.blueprints, function(config, key) {
                    return _c(
                      "option",
                      {
                        key: key,
                        domProps: { value: key, selected: _vm.blueprint == key }
                      },
                ...
                _vm._v(" "),
                _vm.blueprint && _vm.blueprints[_vm.blueprint].help
                  ? _c("div", { staticClass: "help-text help-text mt-2" }, [
                      _vm._v(_vm._s(_vm.blueprints[_vm.blueprint].help))
                    ])
                  : _vm._e()
              ])
            ]),
            ...
            _c(
              "loading-view",
              { attrs: { loading: _vm.fields && _vm.loadingFields } },
              [
    ...
    methods: {
        ...
        getFields: function () {
            var _ref3 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee2() {
                ...
                var _ref4, _ref4$data, panels, fields, blueprint;
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 2:
                                ...
                                _context2.next = 7;
                                return Nova.request().get('/nova-vendor/nova-simple-cms/' + this.resourceName + '/' + this.resourceId + '/update-fields', {
                                    params: {
                                        editing: true,
                                        editMode: 'update',
                                        viaResource: this.viaResource,
                            ...
                            case 7:
                                ...
                                panels = _ref4$data.panels;
                                fields = _ref4$data.fields;
                                blueprint = _ref4$data.blueprint;
        ...
        updateRequest: function updateRequest() {
            ...
            return Nova.request().post('/nova-vendor/nova-simple-cms/' + this.resourceName + '/' + this.resourceId, this.updateResourceFormData, {
                params: {
                    viaResource: this.viaResource,
                    viaResourceId: this.viaResourceId,
                    viaRelationship: this.viaRelationship
            ...
            _c(
              ...
              [
                _c("heading", { staticClass: "mb-3" }, [
                  _vm._v(
                    _vm._s(
                      _vm.__("Edit :resource", { resource: _vm.singularName })
                    )
                  )
                ]),
                _vm._v(" "),
                        ...
                        _c("div", { staticClass: "py-6 px-8 w-1/2" }, [
                          ...
                          _vm.blueprint && _vm.blueprints[_vm.blueprint].help
                            ? _c(
                                ...
                                [
                                  _vm._v(
                                    _vm._s(_vm.blueprints[_vm.blueprint].help)
                                  )
                                ]
                              )
                            : _vm._e()
